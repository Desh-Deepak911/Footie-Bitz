import { applyGeneratedStorySceneCaptions } from "@/features/story/utils";
import { getStoryTotalDuration, normalizeSceneTiming } from "@/features/story/utils";
import { ensureTimelineItems, normalizeSceneIds } from "@/features/story/utils";
...
export function normalizeFootieStory(story: FootieScript): FootieScript {
  ...
  return {
    ...
    ...(story.voiceoverDurationMs != null && story.voiceoverDurationMs > 0
      ? { voiceoverDurationMs: story.voiceoverDurationMs }
      : {}),
  };
}
